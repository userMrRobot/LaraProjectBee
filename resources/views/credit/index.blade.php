...
@section('content')
    ...
    <div class="cart-info">
        <div class="col-lg-5 col-6 cart-if">
            <div class="cart-info-text">
                <div class="side-bar-navigation">
                    <a class="left-info btn btn-success2" href="{{route('credit.up.edit', auth()->user()->id)}}">Получить
                        кредит</a>
        ...
        <div class="col-lg-5 col-6 cart-if">
            <div class="cart-info-text">
                <div class="side-bar-navigation">
                    <a class="left-info btn btn-success2" href="{{route('credit.down.edit', auth()->user()->id)}}">Погасить
                        кредит</a>
