                ...
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item dropdown me">
                        <form action="{{route('logout')}}" method="post">
                            @csrf
                            <button class="nav-link active" type="submit" style="font-size: 17px;" aria-current="page">Выйти</button>
            ...
            <div class="col-lg-4">
                <div class="left-bar">
                    ...
                    <div class="navigation">
                        <div class="header-form"><h4 style="color: #000306;">{{\Illuminate\Support\Facades\Auth::user()->name}}</h4></div>
                    ...
                    <div class="navigation">
                        ...
                        <div class="side-bar-navigation">
                            <a class="left-info btn btn-success2" href="{{route('sellmed.index')}}">Продажа меда</a>
                        </div>
                        <div class="side-bar-navigation">
                    ...
                    <div class="navigation">
                        ...
                        <div class="side-bar-navigation">
                            <a class="left-info btn btn-success2" href="{{route('daybonus.index')}}">Дневной бонус</a>
                        </div>
