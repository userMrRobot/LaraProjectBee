            ...
            <div class="card mb-3" style="width: 12rem;text-align: center;">
                ...
                <div class="card-body">
                    <form action="#" method="post">
                        ...
                        <a class="btn btn-primary" href="{{route('shop.bee1.edit', auth()->user()->id)}}">Купить</a>
            ...
            <div class="card mb-3" style="width: 12rem;text-align: center;">
                ...
                <div class="card-body">
                    <form action="#" method="post">
                        ...
                        <a class="btn btn-primary" href="{{route('shop.bee2.edit', auth()->user()->id)}}">Купить</a>
                    </form>
                </div>
            ...
            <div class="card mb-3" style="width: 12rem;text-align: center;">
                ...
                <div class="card-body">
                    <form action="#" method="post">
                        ...
                        <a class="btn btn-primary" href="{{route('shop.bee3.edit', auth()->user()->id)}}">Купить</a>
                    </form>
                </div>
            </div>
        </div>
